...
class ControllerExtensionModuleWebinewsletter extends Controller {
	...
	public function index($setting) {
		...
		$config_theme = $this->config->get('theme_plantish_directory');
		...
		// } else {
		// 	$this->document->addStyle('catalog/view/theme/plantish/stylesheet/webinewsletter.css');
		// }
		...
		$this->mdata['mode']        = isset($setting['displaymode']) ? $setting['displaymode'] : "plantish";
